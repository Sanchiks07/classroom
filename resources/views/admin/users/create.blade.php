                ...
                <div class="container mx-auto p-6 sm:px-4">
                    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4 sm:max-w-md lg:max-w-full sm:mx-auto">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="username" class="block mt-1 w-full lg:w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 dark:bg-gray-700 dark:text-gray-200" type="text" name="username" value="{{ old('username') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="email" class="block mt-1 w-full lg:w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 dark:bg-gray-700 dark:text-gray-200" type="email" name="email" value="{{ old('email') }}" required>
                        ...
                        <!-- Password -->
                        <div class="mb-4">
                            <label for="password" class="block text-gray-700 dark:text-gray-200 font-medium">{{ __('Password') }}</label>
                            <input id="password" class="block mt-1 w-full lg:w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 dark:bg-gray-700 dark:text-gray-200" type="password" name="password" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="password_confirmation" class="block mt-1 w-full lg:w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 dark:bg-gray-700 dark:text-gray-200" type="password" name="password_confirmation" required>
